...
export const gameNightSettings = sqliteTable("game_night_settings", {
  ...
  teamCountMode: text("team_count_mode").notNull().default("manual"),
  targetTeamCount: integer("target_team_count").notNull(),
  teamSizeMode: text("team_size_mode").notNull().default("manual"),
  ...
  boardCountMode: text("board_count_mode").notNull().default("manual"),
