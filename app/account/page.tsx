        ...
        <header className="mb-6 flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-[var(--color-text-muted)]">
              Sign in to open your league workspace and synchronize completed matches.
            </p>
            <Link
              href="/league-play"
              className="mt-4 inline-flex min-h-11 items-center justify-center rounded-xl bg-[var(--color-primary)] px-5 py-2.5 font-black text-white hover:bg-[var(--color-primary-hover)]"
            >
              League Home
            </Link>
          </div>
          <Link
            href="/help?from=account"
            aria-label="Help"
