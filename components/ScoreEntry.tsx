...
export function ScoreEntry({
    ...
    return (
        ...
        >
                        ...
                        {isCurrentThrowerDummy ? (
                            ...
                            <>
                                ...
                                <div className={compact ? "mb-3 grid grid-cols-2 gap-2" : "mb-4 grid grid-cols-2 gap-3"}>
                                    <input
                                        className={`w-full rounded-xl bg-[var(--color-panel-soft)] border border-[var(--color-panel-border)] text-center ${compact ? "p-2 text-2xl cursor-default" : "p-4 text-3xl"
                                            }`}
                                        value={scoreInput}
                                        readOnly={compact}
                                        onFocus={(event) => {
                                    ...
                                    <button
                                        onClick={submitScore}
                                        className={`rounded-xl bg-[var(--color-success)] hover:bg-[var(--color-success-hover)] font-bold whitespace-nowrap ${compact ? "px-5 py-2 text-base" : "px-6 py-4 text-xl"
                                            }`}
                                    >
                                        Enter Score
                                    </button>
                                    ...
                                    >
                                        {quickScores.map((score) => (
                                            <button
                                                ...
                                                className={`rounded-xl bg-[var(--color-panel-soft)] hover:bg-[var(--color-panel-border)] border border-[var(--color-panel-border)] font-bold ${compact ? "p-2 text-base" : "p-4 text-xl"
                                                    }`}
                                            >
                                                {score}
                                            </button>
            ...
            <button
                onClick={undoLastTurn}
                className={`mt-2 w-full rounded-xl bg-[var(--color-warning)] hover:bg-[var(--color-warning-hover)] font-bold ${compact ? "p-2 text-base" : "p-4 text-xl"
                    }`}
            >
                Undo Last Turn
            </button>
