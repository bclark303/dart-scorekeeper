...
return (
  ...
  >
    <div className="flex items-start justify-between gap-3">
      <div>
        <h2 className={compact ? "text-xl font-semibold" : "text-2xl font-semibold mb-2"}>
          {player.name}
        </h2>
    ...
    <div className={compact ? "mt-3 text-6xl font-bold" : "mt-3 text-6xl font-bold"}>
      {player.score}
    </div>

    <div className={compact ? "mt-3 grid grid-cols-2 gap-2 text-base" : "mt-4 grid grid-cols-1 gap-2 text-xl"}>
      <div>
      ...
      {checkoutText && (
        ...
        >
          ...
          <div className={compact ? "text-lg font-bold text-green-100" : "text-xl font-bold text-green-100"}>
            {checkoutText}
          </div>
        </div>
      )}
